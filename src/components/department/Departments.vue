<template>
    ...
    <v-container>
      <div class="d-flex flex-row align-center justify-space-between mb-6">
        ...
        <div>
          <DepartmentRegistor  @departmentAdded="handleActionType('add')"   @add-department="handleaddingFinished"  />
        </div>
      </div>
      <v-row class="pa-4" col="12" md="12">
        ...
        >
          <template v-slot:[`item.action`]="{ item }">
            <EditDepartment :item="item"  @departmentEdit="handleActionType('edit')"  @editing-finished="handleEditingFinished"/>
